...
const Footer = () => {
    return (
        <div className='dark:bg-gray-800/50 bg-[#f6f8f6] flex flex-col justify-center items-center pt-4 pb-8 px-3 sm:px-5 w-full'>
            ...
            <div className='flex gap-3 mt-2'>
                ...
                <Link href='https://www.github.com/TokomNyori/' target='_blank'>
                    <AiFillGithub className='text-xl dark:text-slate-200/90' />
                </Link>
