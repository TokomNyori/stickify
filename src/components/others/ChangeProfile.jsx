...
const ChangeProfile = ({ user, getUserCookie, toggleLoading }) => {
    ...
    return (
        <div className="w-[80%] lg:w-[25%] sm:w-[60%]">
            <form className="" onSubmit={handleSubmit} >
                <div className='avatars'>
                    <div className="radio-inputs mb-4 flex justify-center gap-3 mt-2">
                        <div>
                            <input type="radio" id="boyOne" name="avatar" className="hidden manage-radio-btn" value="boy1"
                ...
                <button className='border hover:border-[1.4px] dark:border-[#e6e9e7] focus:outline-none 
                    font-medium rounded-lg text-sm px-5 py-2.5 mb-2 focus:ring-gray-700 block w-full border-gray-800'
                    type="submit"
                >
