...
const TextFormatComp = ({ applyFormattingToSelectedText, parentRef, ctx }) => {
    ...
    return (
        <div
            ...
            w-6 text-center font-normal backdrop-blur-[7px]`}
            ...
            w-7 text-center backdrop-blur-[7px]'
            ...
            <div className='rounded-full px-1 py-0 cursor-move text-gray-800 backdrop-blur-[7px]
            text-center'
            >
