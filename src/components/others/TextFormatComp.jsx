...
const TextFormatComp = ({ applyFormattingToSelectedText, parentRef }) => {
    ...
    return (
        <motion.div
            ...
            w-6 text-center font-normal backdrop-blur-[6px]`}
            ...
            w-7 text-center backdrop-blur-[6px]'
            ...
            <div className='rounded-full px-1 py-0 cursor-move text-gray-800 backdrop-blur-[6px]
            text-center'
            >
