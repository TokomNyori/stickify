    ...
    return (
        <div className='px-3 sm:px-64 mt-10'>
            <div className='flex flex-col justify-center items-center'>
                ...
                <div className='the-heading font-bold mb-6 text-xl text-center'>
                    <h2 className='text-center'>Support Stickify:</h2>
                    <h2 className='text-center'>A Message from the Developer</h2>
                </div>
                <div className='the-message mb-8'>
                    ...
                    <p>
                        For users in India, you can easily donate using the <span className='font-bold'> Google Pay</span> QR code.
                        For our international users, the <span className='font-bold'>Buy Me a Coffee</span> QR code is
                        available for a quick and secure way to support Stickify.
                    </p>
                </div>
                <div className='transaction-section flex flex-col sm:flex-row gap-12 mb-12'>
                    <div className='indian-users flex flex-col items-center'>
                        ...
                        <div className='mb-1'>Or use the UPI ID</div>
                    ...
                    <div className='international-users flex flex-col items-center'>
                        ...
                        <div className='mb-1'>Or click</div>
